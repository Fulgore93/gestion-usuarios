...
class UserUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [           
			'name'      => ['sometimes','string','min:3','max:60','regex:/^[a-zA-ZñÑáéíóú\s]+$/u'],
			'email'     => ['sometimes','email:filter','unique:users,email,'.$id.',id'],
            'password'  => ['sometimes', 'string', 'min:8', 'max:12', new ValidateCustomPassword],
        ];
    }
    /**
